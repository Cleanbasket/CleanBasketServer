...
<body>
	<div class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="../admin/pickup" onfocus="this.blur()">CleanBasket</a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="../admin/order" onfocus="this.blur()">주문현황</a></li>
					<li class="active"><a href="../admin/pickup" onfocus="this.blur()">수거관리</a></li>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<ul style="float: right;" class="list-inline">
					<li>
						배정완료 주문
						<span id="complete-count" class="badge state-count">0</span>
					</li>
					<li>
						미배정 주문
						<span id="incomplete-count" class="badge state-count">0</span>
					</li>
				</ul>
			</div>
			<div class="panel-body">
				<table id="pickup" class="table table-hover">
					<thead>
						<tr>
							<th>주문번호</th>
							<th>수거 예정일</th>
	...
	<script data-jui="#pickup" data-tpl="row" type="text/template">
		<tr>
			<td><!= order_number !></td>
			<td><!= pickup_date !></td>
			<td><!= email !></td>
	...
	<script data-jui="#pickup" data-tpl="none" type="text/template">
		<tr>
	...
	<script>
		...
		function setPickupMan(uid, oid) {
			$.ajax({
				type : 'POST',
				url : '../admin/pickup/assign',
				dataType : 'json',
				contentType : "application/json",
				async : true,
				data : JSON.stringify({
				...
				success : function(json) {
					...
					case constant.SUCCESS:
						getPickupState();
						sendMessage({
							constant : constant.PUSH_ASSIGN_PICKUP,
							uid : uid,
							oid : oid
						});
						break;
