      ...
      <div class="container">
        <section class="section lab">
          <header class="section-header">
            <h2 class="section-title">미세먼지에 대처하는 '세탁'자세</h2>
            ...
            <div class="swiper-container">
              ...
              <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    <img src="./resources/images/img_9/img_09_1.png" alt="">
                  </div>
                  <div class="swiper-slide">
                    <img src="./resources/images/img_9/img_09_2.png" alt="">
                  </div>
                  <div class="swiper-slide">
                    <img src="./resources/images/img_9/img_09_3.png" alt="">
                  </div>
                  <div class="swiper-slide">
                    <img src="./resources/images/img_9/img_09_4.png" alt="">
                  </div>
                  <div class="swiper-slide">
                    <img src="./resources/images/img_9/img_09_5.png" alt="">
                  </div>
                  <div class="swiper-slide">
                    <img src="./resources/images/img_9/img_09_6.png" alt="">
                  </div>
                  <div class="swiper-slide">
                    <img src="./resources/images/img_9/img_09_7.png" alt="">
                  </div>
              </div>
          ...
          <div class="lab-text">
            <p>
              목도리, 스웨터, 모직의류는 정전기가 심해서 미세먼지가 더 잘 달라붙습니다. <br>
              때문에 외부의 미세먼지가 옷에 붙어 내부로 들어올 수 있다는 것. <br>
              외출 후 의류관리가 건강관리로 이어질 수 있습니다! <br>
              <br>
              크린바스켓의 초간단 미세먼지 제거법을 확인해보세요! <br>
            </p>
          </div>
          <div class="lab-tag">
            <span class="tag"># 미세먼지대처법</span>
            <span class="tag"># 미세먼지세탁</span>
          </div>
          <hr class="lab-hr">
