...
<body>
	...
	<div style="margin: 25px; margin-bottom: 0px;">
		<a class="btn btn-info btn-lg btn-block" href="intent://#Intent;scheme=cleanbasket;action=android.intent.action.VIEW;category=android.intent.category.BROWSABLE;package=com.bridge4biz.laundry;end">할인쿠폰
			사용하기</a>
	</div>
</body>
</html>